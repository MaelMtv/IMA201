...
plt.imshow(np.abs(unew-v)) #u avec l'histogramme de v
...
im2=quantize(im,5)
#plt.imshow(im2)
plt.imshow(seuil(im,100))
#plt.imshow(seuil(noise(im,40),100)) #exemple de dithering
